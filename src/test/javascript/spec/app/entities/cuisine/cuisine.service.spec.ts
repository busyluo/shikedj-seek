...
describe('Service Tests', () => {
    describe('Cuisine Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CuisineService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cuisines';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Cuisine', () => {
                service.create(new Cuisine(null)).subscribe(received => {
            ...
            it('should update a Cuisine', () => {
                service.update(new Cuisine(123)).subscribe(received => {
