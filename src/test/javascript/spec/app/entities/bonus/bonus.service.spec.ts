    ...
    describe('Bonus Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/bonuses';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Bonus', () => {
                service.create(new Bonus(null)).subscribe(received => {
            ...
            it('should update a Bonus', () => {
                service.update(new Bonus(123)).subscribe(received => {
