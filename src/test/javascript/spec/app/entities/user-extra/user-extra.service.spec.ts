    ...
    describe('UserExtra Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-extras';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a UserExtra', () => {
                service.create(new UserExtra(null)).subscribe(received => {
            ...
            it('should update a UserExtra', () => {
                service.update(new UserExtra(123)).subscribe(received => {
