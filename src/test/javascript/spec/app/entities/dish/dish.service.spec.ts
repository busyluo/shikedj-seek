    ...
    describe('Dish Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/dishes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Dish', () => {
                service.create(new Dish(null)).subscribe(received => {
            ...
            it('should update a Dish', () => {
                service.update(new Dish(123)).subscribe(received => {
