...
import { MealOrderComponent } from 'app/entities/meal-order/meal-order.component';
...
describe('Component Tests', () => {
    describe('MealOrder Management Component', () => {
        let comp: MealOrderComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MealOrderComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.mealOrders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
