...
describe('Service Tests', () => {
    describe('Province Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProvinceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/provinces';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Province', () => {
                service.create(new Province(null)).subscribe(received => {
            ...
            it('should update a Province', () => {
                service.update(new Province(123)).subscribe(received => {
